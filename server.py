...
server = "10.0.0.91" ################## change to your ip address
port = 8888
currentPlayer = 1
...
s.listen(1)
print("Waiting for slow Comcast to connect, Server Started")
...
def threaded_client(conn, player):
    ...
    while True:
        ...
        try:
            ...
            print('Server has got a issue', e)
            break

    print("Lost service due to poor infrastructure")
    connections -= 1
    try:
